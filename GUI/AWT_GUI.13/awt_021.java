...
class awt_021 extends Frame implements ActionListener
{
	Label l1,l2,l3,l4,l5,l6,l7,l8;
	TextField tf1,tf2,tf3,tf4,tf5,tf6,tf7,tf8,tf9;
	Button b1,b2;
	Checkbox cb1,cb2,cb3,cb4,cb5,cb6,rb1,rb2,rb3;
	CheckboxGroup cbg;
	
	awt_021()
	{
		l1=new Label("KUMAI SWEETS SHOP");
		l1.setBounds(150,50,250,50);
		...
		l8=new Label("Discounts");
		l8.setBounds(50,270,100,20);
		l8.setFont(new Font("Times New Roman",Font.PLAIN,16));
		
		cbg=new CheckboxGroup();
		rb1=new Checkbox("General@10%",true,cbg);
		rb1.setBounds(50,310,100,20);
		
		rb2=new Checkbox("Student@20%",false,cbg);
		rb2.setBounds(50,350,100,20);
		
		rb3=new Checkbox("Staff@30%",false,cbg);
		rb3.setBounds(50,390,100,20);
		...
		b1.setBounds(170,440,100,20);
		b1.addActionListener(this);
		
		b2=new Button("Cancel");
		b2.setBounds(290,440,100,20);
